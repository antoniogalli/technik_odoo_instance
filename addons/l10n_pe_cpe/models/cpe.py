...
class CPE:
    ...
    def _getX509Template(self, content):
        ...
        signature = etree.SubElement(
            content, tag.text, Id="signatureFlexxoone", nsmap={"ds": tag.namespace}
        )
        ...
        reference = etree.SubElement(
            signed_info, tag.text, URI="", nsmap={"ds": tag.namespace}
        )
    ...
    def _getUBLVersion(self, version=None, customization=None):
        ...
        etree.SubElement(self._root, tag.text, nsmap={"cbc": tag.namespace}).text = (
            version or "2.1"
        )
        tag = etree.QName(self._cbc, "CustomizationID")
        etree.SubElement(self._root, tag.text, nsmap={"cbc": tag.namespace}).text = (
            customization or "2.0"
        )
    ...
    def _getDocumentDetail21(self, invoice_id):
        ...
        etree.SubElement(
            self._root, tag.text, nsmap={"cbc": tag.namespace}
        ).text = invoice_id.pe_invoice_date.strftime("%Y-%m-%d")
        tag = etree.QName(self._cbc, "IssueTime")
        etree.SubElement(
            self._root, tag.text, nsmap={"cbc": tag.namespace}
        ).text = invoice_id.pe_invoice_date.strftime("%H:%M:%S")
        if invoice_id.pe_invoice_code in ("01", "03"):
            tag = etree.QName(self._cbc, "InvoiceTypeCode")
            etree.SubElement(
                self._root,
                tag.text,
                listID=invoice_id.pe_sunat_transaction51,
                listAgencyName="PE:SUNAT",
                listName="Tipo de Documento",
                listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo01",
                nsmap={"cbc": tag.namespace},
            ).text = invoice_id.pe_invoice_code
        for line in invoice_id.pe_additional_property_ids:
            tag = etree.QName(self._cbc, "Note")
            etree.SubElement(
                self._root,
                tag.text,
                languageLocaleID=line.code,
                nsmap={"cbc": tag.namespace},
            ).text = line.value
        ...
        etree.SubElement(
            ...
            nsmap={"cbc": tag.namespace},
        ).text = invoice_id.currency_id.name
        ...
        if invoice_id.pe_invoice_code in ("01", "03"):
            sale_ids = invoice_id.invoice_line_ids.mapped("sale_line_ids").mapped(
                "order_id"
            )
            for sale in sale_ids:
                ...
                tag = etree.QName(self._cbc, "ID")
                etree.SubElement(order, tag.text, nsmap={"cbc": tag.namespace}).text = (
                    sale.client_order_ref or sale.name
                )
                break

            if invoice_id.env.context.get(
                "despatch_numbers"
            ) and invoice_id.env.context.get("despatch_numbers", {}).get(invoice_id.id):
                for despatch_number in invoice_id.env.context.get(
                    "despatch_numbers", {}
                ).get(invoice_id.id, []):
                    tag = etree.QName(self._cac, "DespatchDocumentReference")
                    despatch = etree.SubElement(
                        self._root, tag.text, nsmap={"cac": tag.namespace}
                    )
                    tag = etree.QName(self._cbc, "ID")
                    etree.SubElement(
                        despatch, tag.text, nsmap={"cbc": tag.namespace}
                    ).text = despatch_number
            ...
            if invoice_id.pe_additional_type:
                ...
                additional = etree.SubElement(
                    self._root, tag.text, nsmap={"cac": tag.namespace}
                )
                tag = etree.QName(self._cbc, "ID")
                etree.SubElement(
                    additional, tag.text, nsmap={"cbc": tag.namespace}
                ).text = invoice_id.pe_additional_number
                tag = etree.QName(self._cbc, "DocumentTypeCode")
                etree.SubElement(
                    additional, tag.text, nsmap={"cbc": tag.namespace}
                ).text = invoice_id.pe_additional_type
    ...
    def _getSignature(self, invoice_id):
        ...
        tag = etree.QName(self._cbc, "ID")
        etree.SubElement(signature, tag.text, nsmap={"cbc": tag.namespace}).text = (
            invoice_id._name == "pe.cpe" and invoice_id.name or invoice_id.name
        )
        ...
        tag = etree.QName(self._cbc, "ID")
        etree.SubElement(
            identification, tag.text, nsmap={"cbc": tag.namespace}
        ).text = invoice_id.company_id.partner_id.doc_number
        ...
        etree.SubElement(
            name, tag.text, nsmap={"cbc": tag.namespace}
        ).text = invoice_id.company_id.partner_id.legal_name
        ...
        etree.SubElement(
            reference, tag.text, nsmap={"cbc": tag.namespace}
        ).text = "#signatureOdoo"
    ...
    def _getCompany(self, invoice_id):
        ...
        etree.SubElement(
            supplier, tag.text, nsmap={"cbc": tag.namespace}
        ).text = invoice_id.company_id.partner_id.doc_number
        tag = etree.QName(self._cbc, "AdditionalAccountID")
        etree.SubElement(
            supplier, tag.text, nsmap={"cbc": tag.namespace}
        ).text = invoice_id.company_id.partner_id.doc_type
        ...
        etree.SubElement(
            party_name, tag.text, nsmap={"cbc": tag.namespace}
        ).text = etree.CDATA(comercial_name.strip())
        ...
        etree.SubElement(
            address, tag.text, nsmap={"cbc": tag.namespace}
        ).text = invoice_id.company_id.partner_id.l10n_pe_district.code
        ...
        name = (
            invoice_id.company_id.partner_id.legal_name != "-"
            and invoice_id.company_id.partner_id.legal_name
            or invoice_id.company_id.partner_id.name
        )
        etree.SubElement(
            entity, tag.text, nsmap={"cbc": tag.namespace}
        ).text = etree.CDATA(name)
    ...
    def _getCompany21(self, invoice_id):
        ...
        party_identification = etree.SubElement(
            party, tag.text, nsmap={"cac": tag.namespace}
        )
        tag = etree.QName(self._cbc, "ID")
        etree.SubElement(
        ...
        etree.SubElement(
            party_name, tag.text, nsmap={"cbc": tag.namespace}
        ).text = etree.CDATA(comercial_name)
        ...
        etree.SubElement(
            party_legal, tag.text, nsmap={"cbc": tag.namespace}
        ).text = etree.CDATA(legal_name)
        ...
        tag = etree.QName(self._cbc, "AddressTypeCode")
        pe_branch_code = (
            invoice_id.user_id.pe_branch_id.pe_branch_code
            or invoice_id.company_id.pe_branch_code
            or "0000"
        )
        etree.SubElement(
            address, tag.text, nsmap={"cbc": tag.namespace}
        ...
        etree.SubElement(
            addresLine, tag.text, nsmap={"cbc": tag.namespace}
        ).text = etree.CDATA(street_id)
    ...
    def _getDeliveryTerms(self, invoice_id):
        ...
        etree.SubElement(
            address, tag.text, nsmap={"cbc": tag.namespace}
        ).text = partner_id.street[:200]
        tag = etree.QName(self._cbc, "CitySubdivisionName")
        etree.SubElement(address, tag.text, nsmap={"cbc": tag.namespace}).text = (
            partner_id.street2 and partner_id.street2[:25] or ""
        )
        tag = etree.QName(self._cbc, "ID")
        etree.SubElement(
            address,
            ...
            schemeName="Ubigeos",
            nsmap={"cbc": tag.namespace},
        ).text = partner_id.l10n_pe_district.code
        tag = etree.QName(self._cbc, "CountrySubentity")
        etree.SubElement(address, tag.text, nsmap={"cbc": tag.namespace}).text = (
        ...
        tag = etree.QName(self._cbc, "District")
        etree.SubElement(address, tag.text, nsmap={"cbc": tag.namespace}).text = (
            partner_id.l10n_pe_district.name or "-"
        )
        tag = etree.QName(self._cac, "Country")
        ...
        etree.SubElement(
            ...
            partner_id.country_id.code or "-"
        )

    def _getPartner(self, invoice_id, line=None):
        tag = etree.QName(self._cac, "AccountingCustomerParty")
        customer = etree.SubElement(
            line or self._root, tag.text, nsmap={"cac": tag.namespace}
        )
        tag = etree.QName(self._cbc, "CustomerAssignedAccountID")
        partner_id = invoice_id.partner_id.parent_id or invoice_id.partner_id
        etree.SubElement(customer, tag.text, nsmap={"cbc": tag.namespace}).text = (
            partner_id.doc_number or partner_id.parent_id.doc_number or "0"
        )
        tag = etree.QName(self._cbc, "AdditionalAccountID")
        etree.SubElement(customer, tag.text, nsmap={"cbc": tag.namespace}).text = (
            partner_id.doc_type or partner_id.parent_id.doc_type or "-"
        )
        if not line:
            tag = etree.QName(self._cac, "Party")
            ...
            etree.SubElement(
                entity, tag.text, nsmap={"cbc": tag.namespace}
            ).text = etree.CDATA(partner_id.name or "-")
    ...
    def _getPartner21(self, invoice_id, line=None):
        ...
        etree.SubElement(
            party_identification,
            tag.text,
            schemeID=partner_id.doc_type or "-",
            schemeName="Documento de Identidad",
            schemeAgencyName="PE:SUNAT",
            schemeURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo06",
            nsmap={"cbc": tag.namespace},
        ).text = (
            partner_id.doc_number or "-"
        )
        tag = etree.QName(self._cac, "PartyLegalEntity")
        party_legal = etree.SubElement(party, tag.text, nsmap={"cac": tag.namespace})
        tag = etree.QName(self._cbc, "RegistrationName")
        legal_name = (
            partner_id.legal_name
            and partner_id.legal_name.strip() != "-"
            and partner_id.legal_name.strip()
            or partner_id.name
            or "-"
        )
        ...
        for inv in invoice_id.pe_related_ids:
            ...
            if invoice_id.type == "out_invoice":
                etree.SubElement(
                    ...
                    nsmap={"cbc": tag.namespace},
                ).text = invoice_id.pe_debit_note_code
            else:
                if invoice_id.type == "out_refund":
                    etree.SubElement(
                        ...
                        nsmap={"cbc": tag.namespace},
                    ).text = invoice_id.pe_credit_note_code
            tag = etree.QName(self._cbc, "Description")
            etree.SubElement(
                discrepancy, tag.text, nsmap={"cbc": tag.namespace}
            ).text = etree.CDATA(
    ...
    def _getBillingReference(self, invoice_id, line=None):
        for inv in invoice_id.pe_related_ids:
            ...
            invoice = etree.SubElement(
                reference, tag.text, nsmap={"cac": tag.namespace}
            )
            tag = etree.QName(self._cbc, "ID")
            etree.SubElement(
                invoice, tag.text, nsmap={"cbc": tag.namespace}
            ).text = inv.name
            tag = etree.QName(self._cbc, "DocumentTypeCode")
            etree.SubElement(
                invoice, tag.text, nsmap={"cbc": tag.namespace}
            ).text = inv.pe_invoice_code
    ...
    def _getDespatchDocumentReference21(self, invoice_id):
        for despatch_number in invoice_id.env.context.get("despatch_numbers", {}).get(
            invoice_id.id, []
        ):
            tag = etree.QName(self._cac, "DespatchDocumentReference")
            reference = etree.SubElement(
    ...
    def _getPrepaidPayment(self, invoice_id):
        for line in (
            invoice_id.invoice_line_ids.mapped("sale_line_ids")
            .mapped("order_id")
            .mapped("invoice_ids")
            .filtered(
                lambda inv: inv.pe_sunat_transaction in ("04",)
                and inv.pe_invoice_code in ("01", "03")
                and inv.id != invoice_id.id
            ...
            if line.pe_invoice_code == "01":
                etree.SubElement(
                    prepaid, tag.text, schemeID="02", nsmap={"cbc": tag.namespace}
                ).text = line.name
            else:
                if line.pe_invoice_code == "03":
                    etree.SubElement(
                        prepaid, tag.text, schemeID="03", nsmap={"cbc": tag.namespace}
                    ).text = line.name
            tag = etree.QName(self._cbc, "PaidAmount")
            etree.SubElement(
                prepaid,
                tag.text,
                currencyID=invoice_id.currency_id.name,
                nsmap={"cbc": tag.namespace},
            ).text = str(round(line.amount_total, 2))
            tag = etree.QName(self._cbc, "InstructionID")
            etree.SubElement(
                prepaid,
                tag.text,
                schemeID=invoice_id.partner_id.doc_type or "-",
                nsmap={"cbc": tag.namespace},
            ).text = (
                line.partner_id.doc_number or "-"
            )

    def _getPaymentTerms21(self, invoice_id):
        amount_total = invoice_id.amount_total
        payment_term = invoice_id.invoice_payment_term_id
        if not payment_term:
            payment_term = invoice_id.get_default_payment_term()
            invoice_id.invoice_payment_term_id = payment_term
        if payment_term:
            computed_payment_terms = payment_term.compute(amount_total, invoice_id.date)
            tag = etree.QName(self._cac, "PaymentTerms")
            payment = etree.SubElement(
                self._root, tag.text, nsmap={"cac": tag.namespace}
            )
            tag = etree.QName(self._cbc, "ID")
            etree.SubElement(payment, tag.text).text = "FormaPago"
            tag = etree.QName(self._cbc, "PaymentMeansID")
            etree.SubElement(payment, tag.text).text = payment_term.sunat_payment_type
            ...
            etree.SubElement(
                ...
                currencyID=invoice_id.currency_id.name,
                nsmap={"cbc": tag.namespace},
            ).text = str(round(amount_total, 2))

            if payment_term.sunat_payment_type == "Credito":
                payment_number = 1
                for payment_date, payment_amount in computed_payment_terms:
                    tag = etree.QName(self._cac, "PaymentTerms")
                    payment = etree.SubElement(
                        self._root, tag.text, nsmap={"cac": tag.namespace}
                    )
                    ...
                    etree.SubElement(payment, tag.text).text = "FormaPago"
                    tag = etree.QName(self._cbc, "PaymentMeansID")
                    etree.SubElement(payment, tag.text).text = "Cuota{:03d}".format(
                        payment_number
                    )
                    tag = etree.QName(self._cbc, "Amount")
                    etree.SubElement(
                        ...
                        currencyID=invoice_id.currency_id.name,
                        nsmap={"cbc": tag.namespace},
                    ).text = str(round(payment_amount, 2))
                    tag = etree.QName(self._cbc, "PaymentDueDate")
                    etree.SubElement(payment, tag.text).text = payment_date
    ...
    def _getTaxTotal(self, invoice_id):
        ...
        for tax in invoice_id.tax_line_ids.filtered(
            ...
            and tax.tax_id.pe_is_charge == False
        ):
            ...
            etree.SubElement(
                ...
                currencyID=invoice_id.currency_id.name,
                nsmap={"cbc": tag.namespace},
            ).text = str(round(tax.amount, 2))
            tag = etree.QName(self._cac, "TaxSubtotal")
            tax_subtotal = etree.SubElement(
                total, tag.text, nsmap={"cac": tag.namespace}
            )
            tag = etree.QName(self._cbc, "TaxAmount")
            amount_tax_line = invoice_id.currency_id.round(
                tax.amount * (1 - (invoice_id.discount_rate or 0.0) / 100)
            )
            etree.SubElement(
                tax_subtotal,
                tag.text,
                currencyID=invoice_id.currency_id.name,
                nsmap={"cbc": tag.namespace},
            ).text = str(round(amount_tax_line, 2))
            tag = etree.QName(self._cac, "TaxCategory")
            category = etree.SubElement(
                tax_subtotal, tag.text, nsmap={"cac": tag.namespace}
            )
            tag = etree.QName(self._cac, "TaxScheme")
            scheme = etree.SubElement(category, tag.text, nsmap={"cac": tag.namespace})
            tag = etree.QName(self._cbc, "ID")
            etree.SubElement(
                scheme, tag.text, nsmap={"cbc": tag.namespace}
            ).text = tax.tax_id.pe_tax_type.code
            tag = etree.QName(self._cbc, "Name")
            etree.SubElement(
                scheme, tag.text, nsmap={"cbc": tag.namespace}
            ).text = tax.tax_id.pe_tax_type.name
            tag = etree.QName(self._cbc, "TaxTypeCode")
            etree.SubElement(
                scheme, tag.text, nsmap={"cbc": tag.namespace}
            ).text = tax.tax_id.pe_tax_type.un_ece_code

        if not invoice_id.tax_line_ids.filtered(
            lambda tax: tax.tax_id.pe_tax_type.code == "1000"
            and tax.tax_id.pe_is_charge == False
        ):
            tag = etree.QName(self._cac, "TaxTotal")
            total = etree.SubElement(self._root, tag.text, nsmap={"cac": tag.namespace})
    ...
    def _getTaxTotal21(self, invoice_id):
        ...
        for group_tax in invoice_id.amount_by_group:
            tax = invoice_id.line_ids.mapped("tax_ids").filtered(
                lambda x: x.tax_group_id.id == group_tax[-1]
            )
            tax = tax and tax[0]
            if tax.l10n_pe_edi_tax_code != "7152":
                ...
                pass
        amount_tax = (
            invoice_id.pe_amount_tax
        )  # Ya no se esta usando en este metodo Odoo V.13
        etree.SubElement(
            total,
            tag.text,
            currencyID=invoice_id.currency_id.name,
            nsmap={"cbc": tag.namespace},
        ).text = str(round(tax_amount_all, 2))
        for group_tax in invoice_id.amount_by_group:
            ...
            if tax.l10n_pe_edi_tax_code != "7152":
                ...
                if tax.l10n_pe_edi_tax_code == "9996":
                    etree.SubElement(
                        ...
                        currencyID=invoice_id.currency_id.name,
                        nsmap={"cbc": tag.namespace},
                    ).text = str(round(invoice_id.pe_free_amount, 2))
                else:
                    etree.SubElement(
                        tax_subtotal,
                        tag.text,
                        currencyID=invoice_id.currency_id.name,
                        nsmap={"cbc": tag.namespace},
                    ).text = str(round(base_tax_line, 2))
            tag = etree.QName(self._cbc, "TaxAmount")
            if tax.l10n_pe_edi_tax_code == "9996":
                etree.SubElement(
                    tax_subtotal,
            ...
            etree.SubElement(
                ...
                nsmap={"cbc": tag.namespace},
            ).text = tax.l10n_pe_edi_tax_code
            tag = etree.QName(self._cbc, "Name")
            etree.SubElement(
                scheme, tag.text, nsmap={"cbc": tag.namespace}
            ).text = tax.pe_tax_type.name
            tag = etree.QName(self._cbc, "TaxTypeCode")
            etree.SubElement(
                scheme, tag.text, nsmap={"cbc": tag.namespace}
            ).text = tax.pe_tax_type.un_ece_code
        ...
        for tax in tax_ids.filtered(
            lambda tax: tax.l10n_pe_edi_tax_code != "9996" and tax.pe_is_charge == False
        ):
            base_amount = 0.0
            tax_amount = 0.0
            for line in line_ids:
                ...
                if tax.id in line.tax_ids.ids:
                    tax_values = tax.with_context(round=False).compute_all(
                        price_unit,
                    ...
                    base_amount += invoice_id.currency_id.round(
                        tax_values["total_excluded"]
                    )
                    tax_amount += invoice_id.currency_id.round(
                        tax_values["taxes"][0]["amount"]
                    )
    ...
    def _getLegalMonetaryTotal21(self, invoice_id):
        tagname = (
            invoice_id.journal_id.pe_invoice_code == "08"
            and "RequestedMonetaryTotal"
            or "LegalMonetaryTotal"
        )
        ...
        for line in (
            ...
            ).compute(line.amount_total, invoice_id.currency_id)
            prepaid_amount += amount

        other = 0.0
        for tax in invoice_id.line_ids.filtered(
            lambda t: t.tax_line_id.pe_is_charge == True
        ):
        ...
        etree.SubElement(
            ...
            currencyID=invoice_id.currency_id.name,
            nsmap={"cbc": tag.namespace},
        ).text = str(round(amount_untaxed, 2))
    ...
    def _getAllowanceCharge(self, invoice_id):
        if invoice_id.pe_total_discount > 0.0:
            ...
            allowance_charge = etree.SubElement(
                self._root, tag.text, nsmap={"cac": tag.namespace}
            )
            tag = etree.QName(self._cbc, "ChargeIndicator")
            etree.SubElement(
                allowance_charge, tag.text, nsmap={"cbc": tag.namespace}
            ).text = "false"
            ...
            etree.SubElement(
                ...
                round(
                    (invoice_id.pe_total_discount - invoice_id.pe_total_discount_tax)
                    / (
                        invoice_id.amount_untaxed
                        + (
                            invoice_id.pe_total_discount
                            - invoice_id.pe_total_discount_tax
                        )
                    ),
                    5,
                )
            ...
            etree.SubElement(
                ...
                round(
                    invoice_id.pe_total_discount - invoice_id.pe_total_discount_tax, 2
                )
            )
            tag = etree.QName(self._cbc, "BaseAmount")
            amount_total = invoice_id.amount_untaxed + (
                invoice_id.pe_total_discount - invoice_id.pe_total_discount_tax
            )
            etree.SubElement(
                allowance_charge,
    ...
    def _getDocumentLines21(self, invoice_id):
        ...
        for line in invoice_id.invoice_line_ids.filtered(
            lambda ln: ln.price_subtotal >= 0
        ):
            ...
            tag = etree.QName(self._cbc, "ID")
            etree.SubElement(
                inv_line, tag.text, nsmap={"cbc": tag.namespace}
            ).text = str(cont)
            cont += 1
            if invoice_id.pe_invoice_code == "08":
            ...
            etree.SubElement(
                inv_line,
                tag.text,
                unitCode=line.product_uom_id
                and line.product_uom_id.sunat_code
                or "NIU",
            ...
            etree.SubElement(
                ...
                currencyID=invoice_id.currency_id.name,
                nsmap={"cbc": tag.namespace},
            ).text = str(round(line.price_subtotal, 2))
            ...
            if price_unit_all > 0:
                ...
                alternative = etree.SubElement(
                    pricing, tag.text, nsmap={"cac": tag.namespace}
                )
                ...
                if price_unit_all == 0 or invoice_id.pe_invoice_code in ("07", "08"):
                    etree.SubElement(
                        ...
                        currencyID=invoice_id.currency_id.name,
                        nsmap={"cbc": tag.namespace},
                    ).text = str(round(float_round(price_unit_all, 10), 10))
                else:
                    etree.SubElement(
                        alternative,
                        tag.text,
                        ...
                        round(
                            float_round(
                                line.get_price_unit()["total_included"], 10
                            ),
                            10,
                        )
                    )
            ...
            if price_unit_all == 0.0:
                ...
                etree.SubElement(
                    ...
                    round(
                        float_round(line.get_price_unit()["total_included"], 10), 10
                    )
                )
                tag = etree.QName(self._cbc, "PriceTypeCode")
                etree.SubElement(
            ...
            if (
                ...
                and invoice_id.pe_invoice_code not in ("07", "08")
            ):
                tag = etree.QName(self._cac, "AllowanceCharge")
                charge = etree.SubElement(
                    inv_line, tag.text, nsmap={"cac": tag.namespace}
                )
                tag = etree.QName(self._cbc, "ChargeIndicator")
                etree.SubElement(
                    charge, tag.text, nsmap={"cbc": tag.namespace}
                ).text = "false"
                tag = etree.QName(self._cbc, "AllowanceChargeReasonCode")
                etree.SubElement(
                    charge, tag.text, nsmap={"cbc": tag.namespace}
                ...
                etree.SubElement(
                    charge, tag.text, nsmap={"cbc": tag.namespace}
                ).text = str(round(line.discount / 100, 5))
                tag = etree.QName(self._cbc, "Amount")
                etree.SubElement(
                    charge,
                    tag.text,
                    ...
                    round(
                        float_round(
                            line.discount == 100 and 0.0 or line.amount_discount, digits
                        ),
                        2,
                    )
                )
                ...
                etree.SubElement(
                    ...
                    round(
                        float_round(line.price_subtotal + line.amount_discount, digits),
                        2,
                    )
                )
            if line.pe_charge_amount > 0 and invoice_id.pe_invoice_code not in (
                "07",
                "08",
            ):
                tag = etree.QName(self._cac, "AllowanceCharge")
                ...
                etree.SubElement(
                    charge, tag.text, nsmap={"cbc": tag.namespace}
                ).text = str(round(line.pe_charge_amount / line.price_subtotal, 5))
                tag = etree.QName(self._cbc, "Amount")
                etree.SubElement(
                    charge,
                    tag.text,
                    currencyID=invoice_id.currency_id.name,
                    nsmap={"cbc": tag.namespace},
                ).text = str(round(float_round(line.pe_charge_amount, digits), 2))
                tag = etree.QName(self._cbc, "BaseAmount")
                etree.SubElement(
                    charge,
                    tag.text,
            ...
            if line.tax_ids.filtered(lambda tax: tax.l10n_pe_edi_tax_code == "9996"):
                tax_total_values = (
                    ...
                    .filtered(lambda tax: tax.pe_tax_type.code != "9996")
                    .compute_all(
                        line.price_unit,
                        currency=invoice_id.currency_id,
                        quantity=line.quantity,
                ...
                etree.SubElement(
                    ...
                    round(
                        float_round(
                            tax_total_values.get("total_included", 0.0)
                            - tax_total_values.get("total_excluded", 0.0),
                ...
                for tax_val in tax_total_values.get("taxes", []):
                    ...
                    tax_vals[
                        line.tax_ids.filtered(
                            lambda tax: tax.pe_tax_type.code == "9996"
                        )[0].id
                    ] = tax_val
                ...
                if tax.l10n_pe_edi_tax_code == "9996":
                    ...
                    if line.discount == 100:
                        ...
                        etree.SubElement(
                            ...
                            round(
                                float_round(
                                    tax_vals.get(tax.id, {}).get("base", 0.0),
                                    precision_rounding=digits_rounding_precision,
                                ),
                                2,
                            )
                        ...
                        etree.SubElement(
                            ...
                            round(
                                float_round(
                                    tax_vals.get(tax.id, {}).get("amount", 0.0),
                                    precision_rounding=digits_rounding_precision,
                                ),
                                2,
                            )
                        ...
                        tag = etree.QName(self._cac, "TaxCategory")
                        category = etree.SubElement(
                            subtotal, tag.text, nsmap={"cac": tag.namespace}
                        )
                        ...
                        amount = (
                            tax.pe_tax_type.code == "9996"
                            and (
                                len(taxes_ids) > 1
                                and taxes_ids[0].amount
                                or taxes_ids.amount
                            )
                            or tax.amount
                        )
                        etree.SubElement(
                            category, tag.text, nsmap={"cbc": tag.namespace}
                        ).text = str(amount)
                    if tax.pe_tax_type.code == "2000":
                        tag = etree.QName(self._cbc, "TierRange")
                        etree.SubElement(
                            category, tag.text, nsmap={"cbc": tag.namespace}
                        ).text = (line.pe_tier_range or tax.pe_tier_range)
                    else:
                        ...
                        etree.SubElement(
                            ...
                            nsmap={"cbc": tag.namespace},
                        ).text = line.pe_affectation_code
                    tag = etree.QName(self._cac, "TaxScheme")
                    scheme = etree.SubElement(
                        category, tag.text, nsmap={"cac": tag.namespace}
                    )
                    tag = etree.QName(self._cbc, "ID")
                    etree.SubElement(
                        scheme,
                    ...
                    etree.SubElement(
                        subtotal, tag.text, unitCode="NIU", nsmap={"cbc": tag.namespace}
                    ).text = str(int(line.quantity))
                    tag = etree.QName(self._cac, "TaxCategory")
                    category = etree.SubElement(
                        subtotal, tag.text, nsmap={"cac": tag.namespace}
                    )
                    ...
                    if tax.pe_tax_type.code == "2000":
                        ...
                        tax.pe_tax_type.code == "1016"
                    ):  # Agregado por Freddy - todo este bloque
                        tag = etree.QName(self._cbc, "TaxExemptionReasonCode")
                        etree.SubElement(
                            category,
                            tag.text,
            ...
            ).text = etree.CDATA(product_name.strip())
            if line.product_id:
                ...
                etree.SubElement(
                    identification, tag.text, nsmap={"cbc": tag.namespace}
                ).text = (line.product_id and line.product_id.default_code or "-")
                if line.product_id.categ_id.pe_unspsc_code:
                    ...
                    etree.SubElement(
                        ...
                        line.product_id.categ_id.pe_unspsc_code or "-"
                    )
            if (
                line.pe_license_plate
                or invoice_id.pe_license_plate
                and line.product_id.require_plate
            ):
                ...
                etree.SubElement(
                    identification, tag.text, nsmap={"cbc": tag.namespace}
                ).text = "Gastos Art. 37 Renta: Número de Placa"
                ...
                etree.SubElement(
                    identification, tag.text, nsmap={"cbc": tag.namespace}
                ).text = (line.pe_license_plate or invoice_id.pe_license_plate or "")
            ...
            if price_unit_all == 0.0:
                etree.SubElement(
                    ...
                    currencyID=invoice_id.currency_id.name,
                    nsmap={"cbc": tag.namespace},
                ).text = str(round(price_unit_all, 2))
            else:
                etree.SubElement(
                    price,
                    tag.text,
                    currencyID=invoice_id.currency_id.name,
                    nsmap={"cbc": tag.namespace},
                ).text = str(round(line.get_price_unit()["total_excluded"], 10))
    ...
    def getInvoice(self, invoice_id):
        ...
        extensions = etree.SubElement(
            self._root, tag.text, nsmap={"ext": tag.namespace}
        )
        ...
        self._getPaymentTerms21(invoice_id)
    ...
    def getVoidedDocuments(self, batch):
        ...
        etree.SubElement(
            self._root, tag.text, nsmap={"cbc": tag.namespace}
        ).text = batch.date.strftime("%Y-%m-%d")
        tag = etree.QName(self._cbc, "IssueDate")
        etree.SubElement(
            self._root, tag.text, nsmap={"cbc": tag.namespace}
        ).text = batch.send_date.strftime("%Y-%m-%d")
        ...
        for invoice_id in batch.voided_ids:
            if invoice_id.pe_cpe_id.state in ("draft", "generate", "cancel"):
                raise UserError(
                    _(
                        "The invoice N° %s must be sent to the sunat to generate this document."
                    )
                    % invoice_id.name
                )
            ...
            etree.SubElement(line, tag.text, nsmap={"cbc": tag.namespace}).text = str(
                cont
            )
            cont += 1
            tag = etree.QName(self._cbc, "DocumentTypeCode")
            etree.SubElement(
                line, tag.text, nsmap={"cbc": tag.namespace}
            ).text = invoice_id.journal_id.pe_invoice_code
            tag = etree.QName(self._sac, "DocumentSerialID")
            etree.SubElement(line, tag.text, nsmap={"sac": tag.namespace}).text = (
                invoice_id.name and invoice_id.name.split("-")[0]
            )
            tag = etree.QName(self._sac, "DocumentNumberID")
            etree.SubElement(line, tag.text, nsmap={"sac": tag.namespace}).text = (
                invoice_id.name and invoice_id.name.split("-")[1]
            )
            tag = etree.QName(self._sac, "VoidReasonDescription")
            etree.SubElement(line, tag.text, nsmap={"sac": tag.namespace}).text = (
                invoice_id.state in ("cancel", "annul") and "Anulado"
            )
    ...
    def getSummaryDocuments(self, batch):
        ...
        for journal_id in journal_ids:
            ...
            summary_gift = 0
            summary_export = 0
            for invoice_id in batch.summary_ids.filtered(
                lambda inv: inv.journal_id.id == journal_id.id
                ...
                # for tax in invoice_id.tax_line_ids.filtered(lambda tax: tax.tax_id.pe_tax_type.code in ('1000', '2000', '9999') and tax.tax_id.pe_is_charge == False):
                for group_tax in invoice_id.amount_by_group:
                    group_id = group_tax[-1]
                    ...
                    if tax_id.pe_tax_type.code not in ["1000", "2000", "9999", "7152"]:
                        continue
                    amount_tax_line = group_tax[1]
                ...
                line = etree.SubElement(
                    self._root, tag.text, nsmap={"sac": tag.namespace}
                )
                tag = etree.QName(self._cbc, "LineID")
                etree.SubElement(
                    line, tag.text, nsmap={"cbc": tag.namespace}
                ...
                etree.SubElement(
                    line, tag.text, nsmap={"cbc": tag.namespace}
                ).text = journal_id.pe_invoice_code
                tag = etree.QName(self._cbc, "ID")
                etree.SubElement(
                    line, tag.text, nsmap={"cbc": tag.namespace}
                ).text = invoice_id.name
                ...
                if invoice_id.pe_summary_id.is_voided:
                    etree.SubElement(
                        status, tag.text, nsmap={"cbc": tag.namespace}
                    ).text = "3"
                else:
                    etree.SubElement(
                        status, tag.text, nsmap={"cbc": tag.namespace}
                ...
                if invoice_id.pe_taxable_amount > 0:
                    ...
                    etree.SubElement(
                        ...
                        currencyID=currency_code,
                        nsmap={"cbc": tag.namespace},
                    ).text = str(round(invoice_id.pe_taxable_amount, 2))
                    tag = etree.QName(self._cbc, "InstructionID")
                    etree.SubElement(
                        billing, tag.text, nsmap={"cbc": tag.namespace}
                    ).text = "01"
                if invoice_id.pe_exonerated_amount > 0:
                    ...
                    etree.SubElement(
                        ...
                        currencyID=currency_code,
                        nsmap={"cbc": tag.namespace},
                    ).text = str(round(invoice_id.pe_exonerated_amount, 2))
                    tag = etree.QName(self._cbc, "InstructionID")
                    etree.SubElement(
                        billing, tag.text, nsmap={"cbc": tag.namespace}
                    ).text = "02"
                if invoice_id.pe_unaffected_amount > 0:
                    ...
                    etree.SubElement(
                        ...
                        currencyID=currency_code,
                        nsmap={"cbc": tag.namespace},
                    ).text = str(round(invoice_id.pe_unaffected_amount, 2))
                    tag = etree.QName(self._cbc, "InstructionID")
                    etree.SubElement(
                        billing, tag.text, nsmap={"cbc": tag.namespace}
                    ).text = "03"
                ...
                if summary_allowcharge > 0:
                    ...
                    allowance = etree.SubElement(
                        line, tag.text, nsmap={"cac": tag.namespace}
                    )
                    tag = etree.QName(self._cbc, "ChargeIndicator")
                    etree.SubElement(
                        allowance, tag.text, nsmap={"cbc": tag.namespace}
                    ).text = "false"
                    tag = etree.QName(self._cbc, "Amount")
                    etree.SubElement(
                        allowance,
                        ...
                        currencyID=currency_code,
                        nsmap={"cbc": tag.namespace},
                    ).text = str(round(summary_allowcharge, 2))
                if invoice_id.pe_charge_total > 0:
                    ...
                    etree.SubElement(
                        ...
                        currencyID=currency_code,
                        nsmap={"cbc": tag.namespace},
                    ).text = str(round(invoice_id.pe_charge_total, 2))
                for tax in taxes:
                    if tax["tax_name"] == "9999" and tax["amount_tax_line"] > 0:
                        ...
                        etree.SubElement(
                            ...
                            currencyID=currency_code,
                            nsmap={"cbc": tag.namespace},
                        ).text = str(round(tax["amount_tax_line"], 2))
                        tag = etree.QName(self._cac, "TaxSubtotal")
                        tax_subtotal = etree.SubElement(
                            total, tag.text, nsmap={"cac": tag.namespace}
                        )
                        ...
                        etree.SubElement(
                            scheme, tag.text, nsmap={"cbc": tag.namespace}
                        ).text = str(tax["tax_name"])
                        tag = etree.QName(self._cbc, "Name")
                        etree.SubElement(
                            scheme, tag.text, nsmap={"cbc": tag.namespace}
                        ).text = str(tax["tax_description"])
                        tag = etree.QName(self._cbc, "TaxTypeCode")
                        etree.SubElement(
                            scheme, tag.text, nsmap={"cbc": tag.namespace}
                        ).text = str(tax["tax_type_pe"])
                        ...
                        elif tax["amount_tax_line"] > 0 or tax["tax_name"] == "7152":
                            tag = etree.QName(self._cac, "TaxTotal")
                            total = etree.SubElement(
                                line, tag.text, nsmap={"cac": tag.namespace}
                            )
...
class Client(object):
    def __init__(
        self, ruc, username, password, url, debug=False, type=None, server=None
    ):
        self._type = type
    ...
    def _call_service(self, name, params):
        if not self._type:
            try:
                ...
                return (
                    False,
                    {"faultcode": ex.faultcode, "faultstring": ex.faultstring},
                )
...
def get_document_invoice(invoice_id):
    ...
    sunat_url = (
        ICPSudo.get_param("web.base.url").replace("http://", "").replace("https://", "")
    )
...
def get_status_cdr(send_number, client):
    ...
    client["url"] = "https://ww1.sunat.gob.pe/ol-it-wsconscpegem/billConsultService"
